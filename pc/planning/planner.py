...
class Planner:
    ...
    def __init__(self, our_side, pitch_num):
        ...
        self._defender_strategies = {'defence'  : [DefenderDefend, DefenderPenalty],
                                     'grab'     : [DefenderGrab],
                                     'pass'     : [DefenderPass],
	...
	# Ball in our zone or in their attacker's zone and moving, need to defend
        elif (self._world.pitch.zones[our_defender.zone].isInside(ball.x, ball.y) 
	  or self._world.pitch.zones[our_defender.zone].isInside(ball.x, ball.y)) and ball.velocity >= BALL_VELOCITY:
	...
	# Ball still far or not moving, take defensive position
	else:
